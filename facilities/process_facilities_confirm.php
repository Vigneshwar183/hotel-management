...
if($row_id)
{
	$room_confirm = mysql_query("SELECT * FROM $room WHERE room_no = '$room_no' ");
	...
	{		 
		...
		{
		  ?> <div class="lged"> <?php
          echo "Congratz ".$row_id['username']."<br>Your Request has been Received !<br><br><br>";
          ?> </div> <?php
          $result     = mysql_query("SELECT * FROM facility WHERE name = '$serv'");
